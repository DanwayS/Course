let phrases = [ { text: 'отправить другу смешную гифку', image: 'https://code.s3.yandex.net/web-code/procrastinate/1.gif' },
...
function getRandomElement(arr) {
  let randIndex = Math.floor(Math.random(0 , 1) * arr.length);
